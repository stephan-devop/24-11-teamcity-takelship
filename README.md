...
4. [Wie funktioniert das praktisch?](#praktisch)
5. [Welche Vorteile bietet das takelship?](#vorteile)
6. [Wie bedient sich das?](#anschau)
7. [Wie sind takelship-Projekte aufgebaut?](#aufbau)
8. [Welche Technologien werden verwendet?](#technologien)
...
<a id="anschau"></a>
## Wie bedient sich das?

Auf dem Host läuft nur ein Container, aber im takelship laufen viele:
...
Es läuft tatsächlich kein takelship-Container mehr:
...
So stoppen wir die Services auf dem Host: 
